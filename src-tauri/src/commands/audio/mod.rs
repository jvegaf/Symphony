/// Comandos Tauri para operaciones de audio
/// 
...
/// que deben ser accesibles desde donde se invocan.
/// 
/// Los módulos internos contienen estructuras y lógica auxiliar.
...
pub struct AudioPlayerState {
    ...
    pub control_tx: Arc<Mutex<Option<Sender<PlayerControlEvent>>>>,
}
