...
export const Header = ({
  ...
  return (
    <header
      className="bg-white/5 dark:bg-gray-800/50 border-b border-gray-200/10 dark:border-gray-700/50 text-xs text-gray-500 dark:text-gray-400"
      data-testid="header"
    >
      {/* AIDEV-NOTE: Capa draggable que cubre todo el header.
          role="button" y tabIndex=0 lo hacen accesible y evitan el linting error.
          onDoubleClick maximiza/restaura la ventana.
      ...
      >
        {/* Left: Status */}
        <div className="flex items-center space-x-2 min-w-[150px]" style={{ pointerEvents: 'auto' }}>
          {isImporting ? (
        ...
        <div className="flex items-center space-x-2 min-w-[150px] justify-end" style={{ pointerEvents: 'auto' }}>
          {isImporting && (
            <div
